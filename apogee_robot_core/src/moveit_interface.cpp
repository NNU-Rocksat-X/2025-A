...
class MarshaMoveInterface {
    private:
        ...
        // Pose cmd takes name as request and moves to pre-programmed end effector pose
        ...
        // Takes name as request an moves to pre-programmed radian angles for each joint
